...
import { Copy, Image, Info } from 'lucide-react';
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_240px]">
          ...
          <Card className="rounded-[9px] border-[#ffe2e2] bg-[#fffafa] p-6">
            ...
            <div className="mt-5 flex items-center justify-between rounded-[7px] bg-white p-4">
              <div>
                ...
                <p className="text-[11px] text-[#70809a]">Once you delete a workspace, there is no going back.</p>
              </div>
        ...
        <div className="space-y-5">
          <Card className="rounded-[9px] bg-[#eef4ff] p-5">
            ...
            <button className="mt-5 flex h-[108px] w-full flex-col items-center justify-center rounded-[9px] border border-dashed border-[#cbd8ef] bg-[#f8fbff] text-center" type="button">
              <Image className="h-5 w-5 text-[#4c42e8]" />
              <span className="mt-2 text-[11px] font-bold text-[#4c42e8]">Click to upload logo</span>
            ...
            <div className="mt-5">
              <FormField htmlFor="brandColor" label="Primary Brand Color">
                <div className="flex gap-2">
                  <span className="h-9 w-9 rounded-[7px] bg-[#0052cc]" />
          ...
          <Card className="rounded-[9px] bg-[#eef4ff] p-5">
            ...
            <button className="mt-4 flex h-9 w-full items-center justify-between rounded-[7px] bg-white px-3 text-[11px] font-bold text-[#52627b]" type="button">
              wrk_982bNqLp
